...
🎓 **Self Taught Student** | 📚 **Lifelong Learner** | 💾 **Retrocomputing Passionate** | 🎧 **Eighties Enthusiast** | 🌌 **Tech Savvy** | 👽 **SciFi Fan** | ⛪ **Catholic** | 🌄 **Occasional Trekker** | 🔭 **Sky Watcher**

### 👀 my interests:

🌍 **Open Source** | 🐞 **Debugging** | 🛠️ **Assembly Language** | 🔬 **Reverse Engineering** | 🔒 **Infosec** | 🔍 **Digital Forensics** | 🧠 **Computer Architectures** | 📡 **Telecommunications** | 🧩 **Embedded Systems**
